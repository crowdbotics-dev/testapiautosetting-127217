...
## Project Structure
    ...
    ├── testapiautosetting_127217  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127217`
...
2. Clone this repo and `cd testapiautosetting_127217`
